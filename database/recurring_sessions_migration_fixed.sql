-- =====================================================
-- RECURRING SESSIONS MIGRATION (FIXED)
-- Adds support for recurring and scheduled cycle count sessions
-- =====================================================

-- =====================================================
-- STEP 1: UPDATE SESSION_STATUS ENUM (Must run separately)
-- =====================================================
-- NOTE: Enum additions must be committed before use
-- Run this section first, then run STEP 2
...
-- =====================================================
-- STEP 2: MAIN MIGRATION (Run after STEP 1 completes)
-- =====================================================
