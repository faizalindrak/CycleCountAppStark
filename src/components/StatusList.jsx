...
import { Edit, AlertTriangle, TrendingUp, Clock, CheckCircle } from 'lucide-react';

const StatusList = ({ title, items, onFollowUpStatus, getStatusIcon, getFollowUpIcon, emptyMessage }) => {
  if (items.length === 0) {
    return (
